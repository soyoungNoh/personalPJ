...
<span class="upper_menu"><a href="../joinus/loginIndex.jsp" >메인페이지 </a>  >  <a href="../myPage/myPage.do">마이페이지</a>  >  <a href="businessEdit.do">업체정보수정</a>&nbsp &nbsp ${mid}님 환영합니다!(${m.dist})</span>
<br><br>
<hr>
<br><br>

<img alt="seaSports" src="../images/seaSports1.jpg" style="width: 40%;" class="addBImg">
<h1 style="margin: 20px 55px;">업체 정보 수정</h1>
<form action="businessEditProc.do" enctype="multipart/form-data">
...
<table class="mono_table">
    <tbody>
        ...
        <tr>
            <th scope="row">상호명</th>
            <td><input type="text" value="${b.name}" name="bName" class="bBox" id="bName"/></td>
        </tr>
        <tr>
            <th scope="row">가격</th>
        ...
        <tr>
			...
			<input type="text" value="${b.address}" name="address" class="bBox" id="address"/>
			</td>
        </tr>
        <tr>
         ...
         <tr>
            ...
            <td><textarea name="intro" rows=5 cols=40>${b.intro}</textarea><td>
        </tr>
    </tbody>
</table>
	<br><br><br>
<center>
	<div id="buttonLine">
	<span class="pure-button" id="addBtn">"수정하기"</span>
	</div>
</center>
	</form>
